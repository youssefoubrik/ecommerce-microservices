...
import com.oubrik.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail, String customerName, BigDecimal amount,
        ...
        messageHelper.setFrom("yo.oubrik@gmail.com");
        ...
        log.info(String.format("Email successfully send to %s with template %s", destinationEmail, templateName));
    }
